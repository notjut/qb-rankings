...
- **Calibration.** After all points are added, scores are rescaled so the whole list averages exactly 50 with a spread of 10. The stat categories overlap, so without this the spread would be wider.
